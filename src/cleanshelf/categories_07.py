...
# File paths
input_file = r"artifacts\cleanshelf\brands\cleaned_data_transformed_brands.csv"
output_folder = r"artifacts\cleanshelf\categories"
...
categories = {
    "Hair Treatment": r"(treatment|treat|trt|moyonnaise|T-MENT|BOOSTLEAVE)",
...
df['Categories'] = df['Product_Desc'].apply(categorize_product)
